...
class ProductDetailMaleTshirt extends Component {
  //state-hook
  state={
    selected_size: "",
    quantity: 1,
 ...
 render(){
  ...
  return (
    ...
    <Container  style={{ marginTop: "50px"}}>
      ...
      <RadioGroup aria-label="gender" name="size" onChange={this.handleChange}>
          {size &&
          size.map((s,index)=>{
            return (
              <FormControlLabel
...
export default connect(null,mapDispatchToProps)(withRouter(withStyles(styles)(ProductDetailMaleTshirt)));
