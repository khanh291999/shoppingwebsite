...
class ProductDetailFemaleJacket extends Component {
  ...
  componentDidMount(){
    ...
    axios.get(
      `http://localhost:8080/femalejacket/${this.props.match.params.masanpham}`
    )
    .then(res =>{
...
export default connect(null,mapDispatchToProps)(withRouter(withStyles(styles)(ProductDetailFemaleJacket)));
