...
import ProductMaleTshirt from "./ProductFemaleJean";
...
import ProductFemaleJean from "./ProductFemaleJean";
...
function ProductListFemaleJean(props) {
  let total = 0;
  ...
  return (
    <Container maxWidth={false} className="background">
      <div className="categories-title">Women's Jean</div>
...
export default connect(mapStatetoProps, mapDispatchToProps)(ProductListFemaleJean)