    ...
    <div style={{backgroundColor:'#fff'}}>
              ...
              <Grid item xs={6}>
                <div className={classes.paper}>
                  <div id="wave-header-content">
                    <p>We are currently a student at Ho Chi Minh University of Technology and Education</p>
                    <p>This K&Q e-commerce website is our Final-Final project and it use REACT technology to build. This website has some smart features, and its user experience has also improved from the last project.</p>
                    <p>Despite the improvement, there still some error on the website. But feel free to experience because this is our best effort. Thank you.</p>
                  </div>
                </div>
              </Grid>
            </Grid>
        ...
        <section className="about-leader">
          <div style={{width:'80%',margin:'auto'}}>
            <Grid container spacing={3}>
              <Grid item xs={12}>
                <div className={classes.paper} style={{fontSize:'34px',color:'#000'}}>
                  Meet Our <span style={{color:'#b19560', fontWeight:'bold'}}>Member</span>
                </div>
              </Grid>
              <Grid item xs={6} style={{textAlign:'-webkit-center'}}>
                <div>
                  <Grid container spacing={3} style={{textAlign:'-webkit-center center'}}>
                    <Grid item xs={12}>
                      <div id="img-box">
                      ...
                      <div className="leader-info">
                        <div>
                          <div style={{fontSize:'20px', color:'#555f77', fontWeight:600}}>Nguyen Huu Quyen</div>
                          <div style={{marginTop:'10px', fontSize: '16px'}}>17110071</div>
                        </div>
                        <p style={{border: '0.5px solid', width: '8%'}}></p>
                        <div className="leader-decribe">
                          Drives Apptopia’s strategic vision and manages investor relations. Before Apptopia Eli was involved in several startups, including: GPush, Oasys Water, GreatPoint Energy, and DVTel.
                        </div>
                      </div>
                    </Grid>
                  </Grid>
                ...
                <div>
                  <Grid container spacing={3} style={{textAlign:'-webkit-center center'}}>
                    <Grid item xs={12}>
                      ...
                      <div className="leader-info">
                        <div>
                          <div style={{fontSize:'20px', color:'#555f77', fontWeight:600}}>Do Quoc Khanh</div>
                          <div style={{marginTop:'10px', fontSize: '16px'}}>17110041</div>
                        </div>
                        <p style={{border: '0.5px solid', width: '8%'}}></p>
                        <div className="leader-decribe">
                          Drives Apptopia’s strategic vision and manages investor relations. Before Apptopia Eli was involved in several startups, including: GPush, Oasys Water, GreatPoint Energy, and DVTel.
        ...
        <section className="about-store-location">
          <div style={{width:'80%',marginLeft:'auto',marginRight:'auto',marginTop:'5%'}}>
            <Grid container spacing={3}>
              <Grid item xs={12}>
                <div className={classes.paper} style={{fontSize:'34px',color:'#000'}}>
                  Our <span style={{color:'#b19560', fontWeight:'bold'}}>Locations</span>
                </div>
              </Grid>
              <Grid item xs={6} style={{textAlign:'-webkit-center'}}>
                <div>
                  <Grid container spacing={3} style={{textAlign:'-webkit-center center'}}>
                    <Grid item xs={12}>
                      <div style={{margin:'6%'}}>
                      <div style={{width:'170px', height:'220px', display:'inline-block'}}>
                      ...
                      <div style={{display:'inline-block'}}>
                        <div style={{textAlign:'-webkit-left', paddingLeft:'10px', marginRight:'-10px'}}>
                          <div style={{fontSize:'20px', color:'#555f77', fontWeight:600}}>HQ TPHCM</div>
