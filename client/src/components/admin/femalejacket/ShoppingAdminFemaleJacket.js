...
import MainContentFemaleJacket from './MainContentFemaleJacket';
import NavbarFemaleJacket from './NavbarFemaleJacket';
import SidebarFemaleJacket from './SidebarFemaleJacket';
...
export default class ShoppingAdminFemaleJacket extends React.Component {
    state = {
        sidebar_open:true
    }
    toggleSidebar=()=> {
        ...
        return <div className="container-fluid">
            ...
            {/* sidebar dong' => display:none */}
                ...
                <div className={this.state.sidebar_open?"col-md-9":"col-md-12"}>
                    ...
                    <NavbarFemaleJacket toggleSidebar={this.toggleSidebar}/>
                    <MainContentFemaleJacket></MainContentFemaleJacket>
                </div>
            </div>
        </div>
    }
