...
export default class MainContentStaffControl extends React.Component {
  ...
  render() {
    let adminss = this.state.admins.filter(function (admin) {
      return admin.type == 0;
    });
    return (
      <>
        <main className="content">
          <ContentHeaderStaffControl
          ...
          <div className="content-table">
            <div className="table-headers">
              <div className="table-header">Display Name</div>
              <div className="table-header">Password</div>
        ...
        {this.state.open ? (
          <ModalStaffControl
            ...
            editingAdmin={this.state.admins[this.state.isEditting]}
            addAdmin={this.addAdmin}
            toggleModal={this.toggleModal}
