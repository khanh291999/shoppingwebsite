    ...
    Swal.fire({
      ...
      .then((result) => {
        if (result.value) {
          ...
          Swal.fire("Disabled!", "Your product has been disabled.", "success");
        } else if (result.dismiss === Swal.DismissReason.cancel) {
          Swal.fire("Cancelled", "Your prodct is still on sale :)", "error");
        }
      })
      .then((res) => {
        console.log(res);
      ...
      <>
        ...
        {this.state.open ? (
          <Model
            ...
            editingProduct={productss[this.state.isEditting]}
            addProduct={this.addProduct}
            toggleModal={this.toggleModal}
          />
        ) : (
