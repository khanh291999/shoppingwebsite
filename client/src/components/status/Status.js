        ...
        <div className="status-container">
          ...
          <div className="client-content-table">
            <div className="client-table-headers">
              <div className="client-table-header">ID</div>
              <div className="client-table-header">Date</div>
              <div className="client-table-header">Total</div>
              <div className="client-table-header">Status</div>
              <div className="client-table-header">Paid</div>
              <div className="client-table-header">Action</div>
            </div>
          </div>
